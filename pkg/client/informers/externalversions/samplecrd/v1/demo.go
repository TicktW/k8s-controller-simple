...
import (
	...
	versioned "github.com/newgoo/k8s-controller-simple/pkg/client/clientset/versioned"
	internalinterfaces "github.com/newgoo/k8s-controller-simple/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/newgoo/k8s-controller-simple/pkg/client/listers/samplecrd/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecrdV1().Demos(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecrdV1().Demos(namespace).Watch(options)
			},
		},
		&samplecrdv1.Demo{},
		resyncPeriod,
...
func (f *demoInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplecrdv1.Demo{}, f.defaultInformer)
}
